...
@Singleton
// Hier moet een injects of een provides annotation komen
...
) : BookRepositoryStorage
{
    ...
    private fun getBitmapFromUri(uri: Uri): Outcome<Bitmap> {
        val parcelFileDescriptor =
            context.contentResolver.openFileDescriptor(uri, "r") ?: return Outcome.NotFound(null) // Null means file not found
