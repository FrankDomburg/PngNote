...
class PageGrid(
    private val bookIO: BookIO,
    private val pageFiles: List<FastFile>,
                    ...
                    Column(
                        ...
                        0.until(pageGrid.rowNum).forEach { rowIdx ->
                            PageGridRow(
                                ...
                                pageGrid,
                                thumbnails,
                                onOpenPage = { pageIdx -> openPage(pageIdx) })
                        }
                    }
                }
            }
...
fun PageGridRow(
    ...
    rowIdx: Int,
    pageGrid: PageGrid,
    thumbnails: List<MutableLiveData<Bitmap>>,
    onOpenPage: (Int) -> Unit
) {
    Row {
            ...
            if (page.isEmpty) {
                ...
                Card(
                    ...
                    OnePage(
                        ...
                        pageIdx,
                        page,
                        thumbnailState.value!!.asImageBitmap(),
                        pageGrid.bgImage,
                        onOpenPage = { onOpenPage(pageIdx) })
                }
            }
        }
    }
